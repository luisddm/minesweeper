  ...
  $(document).ready(function () {
    ...
    function getVoidsAround($field) {
      ...
      if (i - 1 >= 0 && j - 1 >= 0) {
        ...
        if (typeof $field1.data('mines') === 'undefined' && !$field1.data('revealed')) {
          $voids.push({
            x: i - 1,
            y: j - 1,
          });
      ...
      if (i - 1 >= 0) {
        ...
        if (typeof $field2.data('mines') === 'undefined' && !$field2.data('revealed')) {
          $voids.push({
            x: i - 1,
            y: j,
          });
      ...
      if (i - 1 >= 0 && j + 1 <= boardSize) {
        ...
        if (typeof $field3.data('mines') === 'undefined' && !$field3.data('revealed')) {
          $voids.push({
            x: i - 1,
            y: j + 1,
          });
      ...
      if (j - 1 >= 0) {
        ...
        if (typeof $field4.data('mines') === 'undefined' && !$field4.data('revealed')) {
          $voids.push({
            x: i,
            y: j - 1,
          });
      ...
      if (j + 1 <= boardSize) {
        ...
        if (typeof $field5.data('mines') === 'undefined' && !$field5.data('revealed')) {
          $voids.push({
            x: i,
            y: j + 1,
          });
      ...
      if (i + 1 <= boardSize && j - 1 >= 0) {
        ...
        if (typeof $field6.data('mines') === 'undefined' && !$field6.data('revealed')) {
          $voids.push({
            x: i + 1,
            y: j - 1,
          });
      ...
      if (i + 1 <= boardSize) {
        ...
        if (typeof $field7.data('mines') === 'undefined' && !$field7.data('revealed')) {
          $voids.push({
            x: i + 1,
            y: j,
          });
      ...
      if (i + 1 <= boardSize && j + 1 <= boardSize) {
        ...
        if (typeof $field8.data('mines') === 'undefined' && !$field8.data('revealed')) {
          $voids.push({
            x: i + 1,
            y: j + 1,
          });
